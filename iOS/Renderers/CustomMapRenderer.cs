...
namespace CustomRenderer.iOS
{
	...
	public class CustomMapRenderer : MapRenderer
	{
		...
		MKAnnotationView GetViewForAnnotation(MKMapView mapView, IMKAnnotation annotation)
		{
			...
			{
				annotationView = new CustomMKAnnotationView(annotation, "sucursal");
				annotationView.Image = UIImage.FromFile("pinresuelve.png");
				annotationView.LeftCalloutAccessoryView = new UIImageView(UIImage.FromFile("pinresuelve.png"));
			}
